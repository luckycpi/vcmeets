        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="form-wrapper pt-4 position-relative">
                    <form id="register-form" method="POST" action="{{ route('register') }}" class="animate__animated animate__fadeInUp">
                        @csrf
                            ...
                            <div class="col-md-10">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-4">
                                            <input type="text"
                                                   ...
                                                   autocomplete="name" value="{{ old('name') }}" name="name" autofocus>
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-4">
                                            <input type="text"
                                                   ...
                                                   id="floatingCompany" placeholder="Company" required
                                                   autocomplete="company" value="{{ old('company') }}" name="company"
                                                   autofocus>
                                            @error('company')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-4">
                                            <input type="text"
                                                   ...
                                                   id="floatingDesignation" placeholder="Designation" required
                                                   autocomplete="designation" value="{{ old('designation') }}" name="designation"
                                                   autofocus>
                                            @error('designation')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="text-center">
                                    <a href="#" class="btn-liquid" id="frm-submit">
                                        <span class="inner">{{ __('Register') }}</span>
                                    </a>
                                </div>
    ...
    <script>
        $(document).ready(function () {
            $('#frm-submit').on('click', function (e) {
                e.preventDefault();
                $('#register-form').addClass('animate__fadeOutDown').submit();
